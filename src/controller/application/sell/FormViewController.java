...
public class FormViewController implements Initializable{
    ...
    @FXML
    private ImageView submitButtonImage1;
    ...
    void handleEditButton(ActionEvent event) {
        loadScene("/view/application/sell/formEdit.fxml",(Button)event.getSource());
    ...
    public void handleDoneButton(ActionEvent event) {
        loadScene("/view/application/sell/MainSellWindow.fxml", (Button)event.getSource());
    }
    @Override
    ...
    void populate(ObservableList<String> row){
        ...
        long e = val(labelProductCost.getText()) - paid;
